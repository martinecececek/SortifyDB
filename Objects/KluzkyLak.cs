...
{
    class KluzkyLak(string sap, string nazev, string typ, string jeAktivni, string vyrobce, string pouziti, string nevhodneKombinace, string slozeniDle, Dictionary<string, string> slozeni)
    {
